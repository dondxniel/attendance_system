...
<body>
    <nav class = "navbar navbar-expand-md navbar-dark bg-dark">
        ...
        <div class = "collapse navbar-collapse" id = "navbarCollapse">
            ...
            <form action="courses.php" method="GET" class = "form-inline ml-auto">
                <input type="text" name = "query" class = "form-control mr-sm-2" placeholder = "Search Course Code Or Title">
